...
export const COLUMN_HELP = [
  ...
  ["zone", "Travel zone or the office's own patch, e.g. Zone 2. Shown in Available Rooms."],
  ["bank", "The bank the property's rent is paid into. Shown in Available Rooms — not the same as ownerBankAccount, which is the owner's payout account."],
  ["exTenant", "Last tenant, for Available Rooms. Only used where the room has no tenancy on record — otherwise the list names the tenant from that tenancy."],

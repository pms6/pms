...
const NAV = [
  // Dashboard and Properties lead, followed by the operations sequence the
  // office works through day to day.
  ...
  { href: "/admin/empty-rooms", label: "Empty Rooms Status", icon: DoorOpen },
  ...
  { href: "/admin/email-records", label: "Email Records", icon: Mail },
  { href: "/admin/council-tax-bills", label: "Council Tax and Bills", icon: Landmark },
